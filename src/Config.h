...
class Config {
    ...
    private:
        ...
        void initializeConfigDefs() {
            ...
            _configDefs.emplace("display.fullscreen_brew_timer", ConfigDef::forBool(true));
            _configDefs.emplace("display.blescale_brew_timer", ConfigDef::forBool(false));
            _configDefs.emplace("display.fullscreen_manual_flush_timer", ConfigDef::forBool(true));
