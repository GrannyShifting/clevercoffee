...
// Machine
#define MACHINEID Delonghi // Machine type (see enum MACHINE)
...
#define BREWSWITCH_TYPE       Switch::SW_TRIG          // Switch::TOGGLE or Switch::MOMENTARY (trigger)
...
#define SCALE_TYPE    2 // 0 = one HX711 per load cell, 1 = Only a single HX711 with two channels
